...
if(size(I,3)<4)
    ...
    if(nargout > 1 )
        ...
        %[I,Tx,Ty]=bspline_transform_2d_double_omartmp2(double(O(:,:,1)),double(O(:,:,2)),I,double(Spacing(1)),double(Spacing(2)),double(mode));
    else
